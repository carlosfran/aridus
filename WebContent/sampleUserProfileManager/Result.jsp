...
<jsp:useBean id="sampleUserProfileManagerid" scope="session" class="br.uern.aridus.ws.UserProfileManager" />
...
case 2:
        ...
        String uriprofile_3id=  request.getParameter("uriprofile11");
            java.lang.String uriprofile_3idTemp = null;
        if(!uriprofile_3id.equals("")){
         uriprofile_3idTemp  = uriprofile_3id;
        }
        java.lang.Long create2mtemp = sampleUserProfileManagerid.create(username_0idTemp,psswd_1idTemp,email_2idTemp,uriprofile_3idTemp);
...
case 13:
        gotMethod = true;
        java.lang.Boolean delete13mtemp = sampleUserProfileManagerid.delete();
if(delete13mtemp == null){
%>
<%=delete13mtemp %>
<%
}else{
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(delete13mtemp));
        %>
        <%= tempResultreturnp14 %>
        <%
}
...
case 16:
        ...
        java.lang.Long check16mtemp = sampleUserProfileManagerid.check(username_4idTemp,psswd_5idTemp);
if(check16mtemp == null){
%>
<%=check16mtemp %>
<%
}else{
        String tempResultreturnp17 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(check16mtemp));
        %>
        <%= tempResultreturnp17 %>
        <%
}
...
case 23:
        ...
        java.lang.String getProp23mtemp = sampleUserProfileManagerid.getProp(username_6idTemp,prop_7idTemp);
if(getProp23mtemp == null){
%>
<%=getProp23mtemp %>
<%
}else{
        String tempResultreturnp24 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(getProp23mtemp));
        %>
        <%= tempResultreturnp24 %>
        <%
}
...
case 30:
        ...
        java.lang.Boolean updateProp30mtemp = sampleUserProfileManagerid.updateProp(username_8idTemp,prop_9idTemp,value_10idTemp);
if(updateProp30mtemp == null){
%>
<%=updateProp30mtemp %>
<%
}else{
        String tempResultreturnp31 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(updateProp30mtemp));
        %>
        <%= tempResultreturnp31 %>
        <%
}
