...
@XmlRootElement(name = "listEndpointsByVocabResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listEndpointsByVocabResponse", namespace = "http://model.aridus.uern.br/")

public class ListEndpointsByVocabResponse {
