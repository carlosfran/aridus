...
@XmlRootElement(name = "listEndpointVocabsResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listEndpointVocabsResponse", namespace = "http://model.aridus.uern.br/")

public class ListEndpointVocabsResponse {
