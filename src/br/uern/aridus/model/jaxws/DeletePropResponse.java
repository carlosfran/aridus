...
@XmlRootElement(name = "deletePropResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deletePropResponse", namespace = "http://model.aridus.uern.br/")

public class DeletePropResponse {
