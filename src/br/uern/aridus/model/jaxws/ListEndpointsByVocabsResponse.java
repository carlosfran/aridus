...
@XmlRootElement(name = "listEndpointsByVocabsResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listEndpointsByVocabsResponse", namespace = "http://model.aridus.uern.br/")

public class ListEndpointsByVocabsResponse {
