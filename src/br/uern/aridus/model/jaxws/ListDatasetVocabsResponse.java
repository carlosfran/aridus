...
@XmlRootElement(name = "listDatasetVocabsResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listDatasetVocabsResponse", namespace = "http://model.aridus.uern.br/")

public class ListDatasetVocabsResponse {
