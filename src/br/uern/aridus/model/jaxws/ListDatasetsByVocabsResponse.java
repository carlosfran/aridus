...
@XmlRootElement(name = "listDatasetsByVocabsResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listDatasetsByVocabsResponse", namespace = "http://model.aridus.uern.br/")

public class ListDatasetsByVocabsResponse {
