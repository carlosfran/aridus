...
@XmlRootElement(name = "listDatasetsByUserResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listDatasetsByUserResponse", namespace = "http://model.aridus.uern.br/")

public class ListDatasetsByUserResponse {
