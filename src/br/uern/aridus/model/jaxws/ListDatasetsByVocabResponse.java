...
@XmlRootElement(name = "listDatasetsByVocabResponse", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listDatasetsByVocabResponse", namespace = "http://model.aridus.uern.br/")

public class ListDatasetsByVocabResponse {
