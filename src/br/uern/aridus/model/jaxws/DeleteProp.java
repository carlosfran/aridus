...
@XmlRootElement(name = "deleteProp", namespace = "http://model.aridus.uern.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deleteProp", namespace = "http://model.aridus.uern.br/", propOrder = {"dataset", "prop", "value"})
